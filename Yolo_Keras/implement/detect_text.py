...
class YOLO(object):
    _defaults = {
        "model_path": 'model_data/yolo_66000.h5',

        "anchors_path": 'model_data/anchors_16_update.txt',
    ...
    def detect_image(self, image):
        ...
        for i, c in (list(enumerate(out_classes))):
            ...
            if c == 4:
                try:
                    # img = image[top:bottom+15,left-10:right+2]
                    img = image[top:bottom+5,left-20:right+5]


                    text = read_plate_text.detect(img)
            ...
            if c != self.pre_class and time.time() - self.start < 2:
                continue
